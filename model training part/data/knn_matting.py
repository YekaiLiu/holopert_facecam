...
'''
# very very slow to generate alpha image from trimap and original images
import numpy as np
...
parser.add_argument('--dataroot', type=str, default='./', help="data root directory")
parser.add_argument('--img', type=str, default='1803232313-00000001.jpg',help="img name ")
