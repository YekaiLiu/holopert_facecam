...
python3 deploy.py \
        ...
        --without_gpu
'''
parser = argparse.ArgumentParser(description='test image portrait matting')
#parser.add_argument('--model', default='./pre_trained/erd_seg_matting/model/model_obj.pth', help='pre-Trained model')
parser.add_argument('--model', default='./training model result/portrait_matting/model/model_obj.pth', help='my trained model')


parser.add_argument('--inputPath', default='./test/sr', help='input data path')
parser.add_argument('--savePath', default='./test/sr_seg', help='output data path')
parser.add_argument('--size', type=int, default=256, help='net input size')
parser.add_argument('--without_gpu', action='store_true', default=False, help='use cpu')
