...
def get_args():
    ...
    parser.add_argument('--finetuning', action='store_true', default=True, help='finetuning the training') # lyk If this is your first training, then it would be False rather than True.
